        ...
        >
          ...
          <div class="relative">
            <button
              ...
              class="relative z-10 text-gray-400 hover:text-white"
            >
              <svg
                class="h-6 w-6"
                fill="none"
              ...
              >
                <path
                  ...
                  stroke-linejoin="round"
                  stroke-width="2"
                  d="M12 22s-8 0-8-5.5 8-10.5 8-10.5 8 5.5 8 10.5z"
                ></path>
                <circle
                  cx="12"
                  cy="7"
            ...
            <div
              ...
              class="absolute right-0 top-10 mt-2 w-48 overflow-hidden rounded-lg bg-white shadow-xl"
            >
              <div
          ...
          <div class="relative ml-3">
            <button
              ...
              type="button"
              class="relative flex bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 text-white border border-gray-100 rounded-full pl-4 pr-4 pt-1 pb-1"
              id="user-menu-button"
              aria-expanded="false"
              aria-haspopup="true"
            >
...
const unreadMessages = ref(notificationMessages.value.length);
</script>
